...
OUT_PATH = Path("data/processed/ollama_predictions.jsonl")
    ...
    with OUT_PATH.open("a", encoding="utf-8") as f:
        for _, row in df.iterrows():
            ...
            record = {
                "id": pid,
                "paragraph": paragraph,
                "ollama_is_hazard": pred["is_hazard"],
                "ollama_condition": pred["condition"],
                "ollama_operation": pred["operation"],
                "ollama_state": pred["state"],
                "ollama_hazard_type": pred["hazard_type"],
            }
